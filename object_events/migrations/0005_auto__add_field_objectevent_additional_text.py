...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ObjectEvent.additional_text'
        db.add_column('object_events_objectevent', 'additional_text',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=128, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ObjectEvent.additional_text'
        db.delete_column('object_events_objectevent', 'additional_text')
    ...
    models = {
        ...
        'object_events.objectevent': {
            'Meta': {'ordering': "['-creation_date']", 'object_name': 'ObjectEvent'},
            'additional_text': ('django.db.models.fields.CharField', [], {'max_length': '128', 'blank': 'True'}),
        ...
        'object_events.objecteventtype': {
            'Meta': {'ordering': "['title']", 'object_name': 'ObjectEventType'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
